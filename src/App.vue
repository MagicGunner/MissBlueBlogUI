...
// import headerImagePath from '@/assets/default-cover.jpg'
...
const headerImage = computed(() => {
  return {
    backgroundImage: `url(${commonStore.headerImage}), url(${new URL('@/assets/default-cover.jpg', import.meta.url).href})`,
